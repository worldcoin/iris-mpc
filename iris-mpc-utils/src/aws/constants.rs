...
pub const AWS_REQUESTS_BUCKET_NAME: &str = "wf-smpcv2-dev-sns-requests";

/// AWS: system request ingress queue topic.
pub const AWS_REQUESTS_TOPIC_ARN: &str = "arn:aws:sns:us-east-1:000000000000:iris-mpc-input.fifo";
