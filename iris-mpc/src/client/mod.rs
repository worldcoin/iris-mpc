...
pub struct E2EClient {
    ...
    s3_data: Arc<Vec<IrisCodePartyShares>>,
}
...
impl E2EClient {
    pub async fn new(opts: Opt) -> Self {
        ...
        Self {
            ...
            use_data_from_file: opts.use_data_from_file,
            populate_only_file_data: opts.populate_only_from_file,
    ...
    async fn populate_only_file_data(&self) -> eyre::Result<()> {
        // TODO: Add batch sizes to do the entire file
        let mut party_shares_index = 0;
