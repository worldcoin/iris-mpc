...
use iris_mpc_cpu::{
    ...
    hnsw::{graph::graph_store::GraphPg as GraphStore, GraphMemOld},
};
...
pub struct DbAssertions {
    ...
    pub hnsw_graphs: Option<BothEyes<GraphMemOld<PlaintextStore>>>,
}
...
impl DbAssertions {
    ...
    pub fn assert_hnsw_graphs(mut self, graphs: BothEyes<GraphMemOld<PlaintextStore>>) -> Self {
