...
pub struct NeighborhoodDiff {
    pub only_in_lhs: HashSet<SerialId>,
    pub only_in_rhs: HashSet<SerialId>,
...
pub struct LayerDiffResult {
    ...
    pub diffs: Vec<(SerialId, NeighborhoodDiff)>,
}
...
pub struct ExplicitNeighborhoodDiffer {
    ...
    current_layer_diffs: Vec<(SerialId, NeighborhoodDiff)>,
}
