...
// Actor: produces batches of Iris identifiers for processing.
#[derive(Actor)]
pub struct IrisBatchProducer {
...
impl Message<messages::OnIndexationStart> for IrisBatchProducer {
    // Reply type.
    type Reply = ();
...
impl Message<messages::OnBatchIndexationEnd> for IrisBatchProducer {
    // Reply type.
    type Reply = ();
