...
pub struct UniquenessResult {
    ...
    pub partial_match_rotation_indices_left: Option<Vec<i8>>,
    pub partial_match_rotation_indices_right: Option<Vec<i8>>,
...
impl UniquenessResult {
    ...
    pub fn new(
        ...
        partial_match_rotation_indices_left: Option<Vec<i8>>,
        partial_match_rotation_indices_right: Option<Vec<i8>>,
