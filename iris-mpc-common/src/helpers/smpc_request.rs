use super::{key_pair::SharesDecodingError, sha256::calculate_sha256_string};
...
impl UniquenessRequest {
    ...
    pub fn validate_iris_share(
        ...
        Ok(self.iris_shares_file_hashes[party_id] == calculate_sha256_string(stringified_share))
    }
}
