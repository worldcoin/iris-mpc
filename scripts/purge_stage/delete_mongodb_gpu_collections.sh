...
DATABASE="iris"
COLLECTIONS="mpcv2.results mpcv2.results.partial mpcv2.results.deletion mpcv2.results.anonymized_statistics mpcv2.reauth.results mpcv2.reauth.results.partial"
