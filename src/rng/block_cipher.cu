/*
 * Parts of this file are copied from https://github.com/pytorch/csprng/,
...
#define Nr 10 // The number of rounds in AES Cipher.
  ...
  __constant__ const uint8_t rsbox[256] = {
...
extern "C" __global__ void aes_128_rng(const uint8_t *key_bytes,
                                       int output_elem_per_block, void *output_ptr, int64_t output_numel,
                                       int output_type_size)
{
  block_cipher_kernel_cuda(key_bytes, output_elem_per_block, output_ptr, output_numel, output_type_size, [](uint32_t idx)
                           { return idx; });
}
