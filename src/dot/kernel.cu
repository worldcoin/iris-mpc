...
matmul_correct_and_reduce(int *c, unsigned short *output, int *a0Sums,
                          int *a1Sums, int *b0Sums, int *b1Sums, size_t numRows,
                          size_t numElements, unsigned short *rngMasks0,
...
extern "C" __global__ void openResults(unsigned long long *result1,
