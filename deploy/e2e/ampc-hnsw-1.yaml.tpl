ampc-hnsw-1:
  ...
  env:
    ...
    - name: SMPC__NODE_HOSTNAMES
      value: '["node.0.$ENV.hnsw.worldcoin.dev","0.0.0.0","node.2.$ENV.hnsw.worldcoin.dev"]'
    ...
    - name: SMPC__REQUESTS_QUEUE_URL
      value: "http://sqs.$AWS_REGION.localhost.localstack.cloud:4566/000000000000/hnsw-mpc-request-1-e2e.fifo"
