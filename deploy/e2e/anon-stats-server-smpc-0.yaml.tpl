anon-stats-server-smpc-0:
  ...
  env:
    ...
    - name: SMPC__SERVER_COORDINATION__NODE_HOSTNAMES
      value: '["0.0.0.0","anon-stats-server-1.orb.e2e.test","anon-stats-server-2.orb.e2e.test"]'
    ...
    - name: SMPC__SERVICE__METRICS__PREFIX
      value: "anon-stats-server-$ENV-smpcv2-0"
          ...
          "Changes": [
            {
              "Action": "UPSERT",
              "ResourceRecordSet": {
                "Name": "anon-stats-server-0.orb.e2e.test",
                "TTL": 5,
                "Type": "A",
                "ResourceRecords": [{
                  "Value": "$MY_NODE_IP"
