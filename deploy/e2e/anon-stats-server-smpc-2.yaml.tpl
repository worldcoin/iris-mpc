anon-stat-server-smpc-2:
  fullnameOverride: "anon-stat-server-smpc-2"
  ...
  env:
    ...
    - name: SMPC__SERVICE__SERVICE_NAME
      value: "anon-stats-server-smpcv2-2"
    ...
    - name: SMPC__SERVER_COORDINATION__NODE_HOSTNAMES
      value: '["anon-stats-server-0.orb.e2e.test","anon-stats-server-1.orb.e2e.test","0.0.0.0"]'
    ...
    - name: SMPC__SERVICE__METRICS__PREFIX
      value: "anon-stats-server-$ENV-smpcv2-2"
          ...
          "Changes": [
            {
              "Action": "UPSERT",
              "ResourceRecordSet": {
                "Name": "anon-stats-server-2.orb.e2e.test",
                "TTL": 5,
                "Type": "A",
                "ResourceRecords": [{
                  "Value": "$MY_NODE_IP"
